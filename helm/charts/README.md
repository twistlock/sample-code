...
Note: the Twistlock release should be formatted with underscores as the version separator in the _imageTag_ value (_2_5_127_), and periods for the _version_ value (_2.5.127_).
