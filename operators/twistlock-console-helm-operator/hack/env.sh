...
export OPERATOR_IMAGE_REPO=${OPERATOR_IMAGE_REPO:-"prismacloud/${OPERATOR_NAME}"}
export OPERATOR_IMAGE_TAG=${OPERATOR_IMAGE_TAG:-"v0.0.10-rc1"}
...
export OPERATOR_BUNDLE_IMAGE_REPO=${OPERATOR_BUNDLE_IMAGE_REPO:-"prismacloud/${OPERATOR_BUNDLE_IMAGE_NAME}"}
export OPERATOR_BUNDLE_IMAGE_TAG=${OPERATOR_BUNDLE_IMAGE_TAG:-"v0.0.10-rc1"}
